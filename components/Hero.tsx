...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[100vh] overflow-hidden bg-[url('/tiffany-bg.webp')] bg-cover bg-center bg-no-repeat flex flex-col justify-between">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center my-auto py-16 sm:py-24 space-y-6" dir="rtl">
        <motion.h1
        ...
        >
          نظام التشغيل عالي الأداء للعيادات والممارسات الطبية الحديثة.
        </motion.h1>
        ...
        >
          أتمتة المدوّن الصوتي المباشر لملاحظات SOAP، وتسهيل تدفق المرضى، وتسريع إدارة دورة الإيرادات في منصة واحدة موحدة.
        </motion.p>
