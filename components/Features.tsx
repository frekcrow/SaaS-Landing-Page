...
export function Features() {
  return (
    ...
    >
      ...
      <div
        id="left-circle"
        className="absolute top-1/2 -translate-y-1/2 -left-[52vw] w-[100vw] h-[100vw] rounded-full border-4 border-black bg-transparent pointer-events-none"
      />
      {/* Right circle: positioned extremely to the right, showing left curve '(' near center */}
      <div
        id="Right-circle"
        className="absolute top-1/2 -translate-y-1/2 -right-[52vw] w-[100vw] h-[100vw] rounded-full border-4 border-black bg-transparent pointer-events-none"
      />
    </section>
  );
}
