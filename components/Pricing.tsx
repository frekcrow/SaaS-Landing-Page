...
export function Pricing() {
  ...
  return (
    <section id="pricing" className="w-full bg-[#050505] py-28 px-4 sm:px-8 lg:px-12 text-zinc-100 border-b border-white/[0.06] relative">
        ...
        >
          ...
          <div className="pt-6 flex items-center justify-center gap-4">
            ...
            >
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-[11px] font-mono text-emerald-300">
                SAVE 20%
              </span>
            </span>
          </div>
        ...
        >
          {tiers.map((tier) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex flex-col justify-between h-full p-6 sm:p-8 rounded-3xl relative transition-all duration-300 ${
                    tier.featured
                      ? "bg-zinc-900/90 backdrop-blur-2xl border-2 border-emerald-500/50 shadow-[0_0_60px_rgba(16,185,129,0.18)]"
                      : "bg-zinc-950/70 backdrop-blur-xl border border-white/10 hover:border-white/20 shadow-xl"
                  }`}
                >
                  {/* Featured Badge */}
                  {tier.featured && tier.badge && (
                    <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-10">
                      <div className="bg-emerald-500 text-zinc-950 text-[11px] font-bold uppercase tracking-wider px-4 py-1 rounded-full shadow-lg flex items-center gap-1.5">
                  ...
                  <div className="pt-4 border-t border-white/5">
                    <Button
                      size="lg"
                      className={`w-full font-semibold text-xs sm:text-sm h-12 rounded-full transition-all flex items-center justify-center gap-2 ${
                        tier.featured
                          ? "bg-emerald-500 hover:bg-emerald-400 text-zinc-950 shadow-[0_0_25px_rgba(16,185,129,0.35)]"
